...
func (UnimplementedProviderServer) ReceiveBids(*EmptyMessage, grpc.ServerStreamingServer[Bid]) error {
	return status.Error(codes.Unimplemented, "method ReceiveBids not implemented")
}
func (UnimplementedProviderServer) SendProcessedBids(grpc.ClientStreamingServer[BidResponse, EmptyMessage]) error {
	return status.Error(codes.Unimplemented, "method SendProcessedBids not implemented")
}
func (UnimplementedProviderServer) Stake(context.Context, *StakeRequest) (*StakeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Stake not implemented")
}
...
func (UnimplementedProviderServer) GetMinStake(context.Context, *EmptyMessage) (*StakeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMinStake not implemented")
}
func (UnimplementedProviderServer) WithdrawStake(context.Context, *EmptyMessage) (*WithdrawalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WithdrawStake not implemented")
}
...
func (UnimplementedProviderServer) GetProviderReward(context.Context, *EmptyMessage) (*RewardResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProviderReward not implemented")
}
func (UnimplementedProviderServer) WithdrawProviderReward(context.Context, *EmptyMessage) (*WithdrawalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WithdrawProviderReward not implemented")
}
func (UnimplementedProviderServer) GetCommitmentInfo(context.Context, *GetCommitmentInfoRequest) (*CommitmentInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCommitmentInfo not implemented")
}
func (UnimplementedProviderServer) GetDecryptedTransaction(context.Context, *GetDecryptedTransactionRequest) (*GetDecryptedTransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDecryptedTransaction not implemented")
}
