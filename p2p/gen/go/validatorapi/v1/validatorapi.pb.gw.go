...
func request_Validator_GetEpoch_0(ctx context.Context, marshaler runtime.Marshaler, client ValidatorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Validator_GetEpoch_0(ctx context.Context, marshaler runtime.Marshaler, server ValidatorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EmptyMessage
	var metadata runtime.ServerMetadata
...
func RegisterValidatorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ValidatorServer) error {
	...
	mux.Handle("GET", pattern_Validator_GetEpoch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/validatorapi.v1.Validator/GetEpoch", runtime.WithHTTPPathPattern("/v1/validator/get_epoch"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Validator_GetEpoch_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Validator_GetEpoch_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterValidatorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ValidatorClient) error {
	...
	mux.Handle("GET", pattern_Validator_GetEpoch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/validatorapi.v1.Validator/GetEpoch", runtime.WithHTTPPathPattern("/v1/validator/get_epoch"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Validator_GetEpoch_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Validator_GetEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "validator", "get_epoch"}, ""))
...
var (
	forward_Validator_GetEpoch_0 = runtime.ForwardResponseMessage
