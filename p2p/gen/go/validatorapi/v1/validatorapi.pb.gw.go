...
var filter_Validator_GetValidators_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func RegisterValidatorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ValidatorServer) error {
	mux.Handle(http.MethodGet, pattern_Validator_GetValidators_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
