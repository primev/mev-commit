...
// FilterCommitmentProcessed is a free log retrieval operation binding the contract event 0xe80eda18928974870cd5173c5dd1701b15fbef4871ccd018293f2823680b8704.
//
// Solidity: event CommitmentProcessed(bytes32 indexed commitmentDigest, bool isSlash, uint256 residualBidPercentAfterDecay)
func (_Oracle *OracleFilterer) FilterCommitmentProcessed(opts *bind.FilterOpts, commitmentDigest [][32]byte) (*OracleCommitmentProcessedIterator, error) {
	...
	logs, sub, err := _Oracle.contract.FilterLogs(opts, "CommitmentProcessed", commitmentDigestRule)
	if err != nil {
		return nil, err
	}
...
// WatchCommitmentProcessed is a free log subscription operation binding the contract event 0xe80eda18928974870cd5173c5dd1701b15fbef4871ccd018293f2823680b8704.
//
// Solidity: event CommitmentProcessed(bytes32 indexed commitmentDigest, bool isSlash, uint256 residualBidPercentAfterDecay)
func (_Oracle *OracleFilterer) WatchCommitmentProcessed(opts *bind.WatchOpts, sink chan<- *OracleCommitmentProcessed, commitmentDigest [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Oracle.contract.WatchLogs(opts, "CommitmentProcessed", commitmentDigestRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseCommitmentProcessed is a log parse operation binding the contract event 0xe80eda18928974870cd5173c5dd1701b15fbef4871ccd018293f2823680b8704.
//
// Solidity: event CommitmentProcessed(bytes32 indexed commitmentDigest, bool isSlash, uint256 residualBidPercentAfterDecay)
