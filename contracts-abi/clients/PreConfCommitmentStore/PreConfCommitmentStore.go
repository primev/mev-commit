...
func (_Preconfcommitmentstore *PreconfcommitmentstoreCaller) GetCommitmentIndex(opts *bind.CallOpts, commitment IPreConfCommitmentStoreOpenedCommitment) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function getCommitmentIndex((address,bool,uint64,uint64,uint64,uint64,address,uint256,bytes32,bytes32,bytes,bytes,bytes,string,string) commitment) pure returns(bytes32)
func (_Preconfcommitmentstore *PreconfcommitmentstoreSession) GetCommitmentIndex(commitment IPreConfCommitmentStoreOpenedCommitment) ([32]byte, error) {
...
//
// Solidity: function getCommitmentIndex((address,bool,uint64,uint64,uint64,uint64,address,uint256,bytes32,bytes32,bytes,bytes,bytes,string,string) commitment) pure returns(bytes32)
func (_Preconfcommitmentstore *PreconfcommitmentstoreCallerSession) GetCommitmentIndex(commitment IPreConfCommitmentStoreOpenedCommitment) ([32]byte, error) {
	return _Preconfcommitmentstore.Contract.GetCommitmentIndex(&_Preconfcommitmentstore.CallOpts, commitment)
}
...
//
// Solidity: function openedCommitments(bytes32 ) view returns(address bidder, bool isUsed, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint64 dispatchTimestamp, address committer, uint256 bid, bytes32 bidHash, bytes32 commitmentDigest, bytes bidSignature, bytes commitmentSignature, bytes sharedSecretKey, string txnHash, string revertingTxHashes)
...
//
// Solidity: function unopenedCommitments(bytes32 ) view returns(bool isUsed, address committer, uint64 dispatchTimestamp, bytes32 commitmentDigest, bytes commitmentSignature)
