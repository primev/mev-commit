...
//
// Solidity: function getStakedValidator(bytes valBLSPubKey) view returns((bool,uint256,address,(bool,uint256)))
...
//
// Solidity: function stakedValidators(bytes ) view returns(bool exists, uint256 balance, address withdrawalAddress, (bool,uint256) unstakeHeight)
func (_Validatorregistryv1 *Validatorregistryv1Caller) StakedValidators(opts *bind.CallOpts, arg0 []byte) (struct {
	...
	outstruct.WithdrawalAddress = *abi.ConvertType(out[2], new(common.Address)).(*common.Address)
