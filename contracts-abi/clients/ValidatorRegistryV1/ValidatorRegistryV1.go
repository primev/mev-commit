...
//
// Solidity: function delegateStake(bytes[] valBLSPubKeys, address withdrawalAddress) payable returns()
func (_Validatorregistryv1 *Validatorregistryv1Transactor) DelegateStake(opts *bind.TransactOpts, valBLSPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.contract.Transact(opts, "delegateStake", valBLSPubKeys, withdrawalAddress)
}

// DelegateStake is a paid mutator transaction binding the contract method 0x4b7952b3.
//
// Solidity: function delegateStake(bytes[] valBLSPubKeys, address withdrawalAddress) payable returns()
func (_Validatorregistryv1 *Validatorregistryv1Session) DelegateStake(valBLSPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.Contract.DelegateStake(&_Validatorregistryv1.TransactOpts, valBLSPubKeys, withdrawalAddress)
}

// DelegateStake is a paid mutator transaction binding the contract method 0x4b7952b3.
//
// Solidity: function delegateStake(bytes[] valBLSPubKeys, address withdrawalAddress) payable returns()
func (_Validatorregistryv1 *Validatorregistryv1TransactorSession) DelegateStake(valBLSPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.Contract.DelegateStake(&_Validatorregistryv1.TransactOpts, valBLSPubKeys, withdrawalAddress)
}
