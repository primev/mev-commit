...
//
// Solidity: function initialize(address _executor, address _treasury, address[] _initialSwapTargets) returns()
func (_Fastsettlementv3 *Fastsettlementv3Transactor) Initialize(opts *bind.TransactOpts, _executor common.Address, _treasury common.Address, _initialSwapTargets []common.Address) (*types.Transaction, error) {
	return _Fastsettlementv3.contract.Transact(opts, "initialize", _executor, _treasury, _initialSwapTargets)
}

// Initialize is a paid mutator transaction binding the contract method 0x77a24f36.
//
// Solidity: function initialize(address _executor, address _treasury, address[] _initialSwapTargets) returns()
func (_Fastsettlementv3 *Fastsettlementv3Session) Initialize(_executor common.Address, _treasury common.Address, _initialSwapTargets []common.Address) (*types.Transaction, error) {
	return _Fastsettlementv3.Contract.Initialize(&_Fastsettlementv3.TransactOpts, _executor, _treasury, _initialSwapTargets)
}

// Initialize is a paid mutator transaction binding the contract method 0x77a24f36.
//
// Solidity: function initialize(address _executor, address _treasury, address[] _initialSwapTargets) returns()
func (_Fastsettlementv3 *Fastsettlementv3TransactorSession) Initialize(_executor common.Address, _treasury common.Address, _initialSwapTargets []common.Address) (*types.Transaction, error) {
	return _Fastsettlementv3.Contract.Initialize(&_Fastsettlementv3.TransactOpts, _executor, _treasury, _initialSwapTargets)
}
