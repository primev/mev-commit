...
// GetBidHash is a free data retrieval call binding the contract method 0x2fbf61fa.
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmt, uint256[] _zkProof) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCaller) GetBidHash(opts *bind.CallOpts, _txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmt *big.Int, _zkProof []*big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "getBidHash", _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmt, _zkProof)
...
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmt, uint256[] _zkProof) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerSession) GetBidHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmt *big.Int, _zkProof []*big.Int) ([32]byte, error) {
	return _Preconfmanager.Contract.GetBidHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmt, _zkProof)
}

// GetBidHash is a free data retrieval call binding the contract method 0x2fbf61fa.
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmt, uint256[] _zkProof) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCallerSession) GetBidHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmt *big.Int, _zkProof []*big.Int) ([32]byte, error) {
	return _Preconfmanager.Contract.GetBidHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmt, _zkProof)
}
...
// VerifyBid is a free data retrieval call binding the contract method 0xffdfda33.
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerCaller) VerifyBid(opts *bind.CallOpts, bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, txnHash string, revertingTxHashes string, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "verifyBid", bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, txnHash, revertingTxHashes, bidSignature, slashAmt, zkProof)
...
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerSession) VerifyBid(bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, txnHash string, revertingTxHashes string, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	return _Preconfmanager.Contract.VerifyBid(&_Preconfmanager.CallOpts, bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, txnHash, revertingTxHashes, bidSignature, slashAmt, zkProof)
}

// VerifyBid is a free data retrieval call binding the contract method 0xffdfda33.
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerCallerSession) VerifyBid(bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, txnHash string, revertingTxHashes string, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	return _Preconfmanager.Contract.VerifyBid(&_Preconfmanager.CallOpts, bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, txnHash, revertingTxHashes, bidSignature, slashAmt, zkProof)
...
// OpenCommitment is a paid mutator transaction binding the contract method 0x3d5fc955.
//
// Solidity: function openCommitment(bytes32 unopenedCommitmentIndex, uint256 bidAmt, uint64 blockNumber, string txnHash, string revertingTxHashes, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) returns(bytes32 commitmentIndex)
func (_Preconfmanager *PreconfmanagerTransactor) OpenCommitment(opts *bind.TransactOpts, unopenedCommitmentIndex [32]byte, bidAmt *big.Int, blockNumber uint64, txnHash string, revertingTxHashes string, decayStartTimeStamp uint64, decayEndTimeStamp uint64, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (*types.Transaction, error) {
	return _Preconfmanager.contract.Transact(opts, "openCommitment", unopenedCommitmentIndex, bidAmt, blockNumber, txnHash, revertingTxHashes, decayStartTimeStamp, decayEndTimeStamp, bidSignature, slashAmt, zkProof)
}

// OpenCommitment is a paid mutator transaction binding the contract method 0x3d5fc955.
//
// Solidity: function openCommitment(bytes32 unopenedCommitmentIndex, uint256 bidAmt, uint64 blockNumber, string txnHash, string revertingTxHashes, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) returns(bytes32 commitmentIndex)
func (_Preconfmanager *PreconfmanagerSession) OpenCommitment(unopenedCommitmentIndex [32]byte, bidAmt *big.Int, blockNumber uint64, txnHash string, revertingTxHashes string, decayStartTimeStamp uint64, decayEndTimeStamp uint64, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (*types.Transaction, error) {
	return _Preconfmanager.Contract.OpenCommitment(&_Preconfmanager.TransactOpts, unopenedCommitmentIndex, bidAmt, blockNumber, txnHash, revertingTxHashes, decayStartTimeStamp, decayEndTimeStamp, bidSignature, slashAmt, zkProof)
}

// OpenCommitment is a paid mutator transaction binding the contract method 0x3d5fc955.
//
// Solidity: function openCommitment(bytes32 unopenedCommitmentIndex, uint256 bidAmt, uint64 blockNumber, string txnHash, string revertingTxHashes, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, bytes bidSignature, uint256 slashAmt, uint256[] zkProof) returns(bytes32 commitmentIndex)
func (_Preconfmanager *PreconfmanagerTransactorSession) OpenCommitment(unopenedCommitmentIndex [32]byte, bidAmt *big.Int, blockNumber uint64, txnHash string, revertingTxHashes string, decayStartTimeStamp uint64, decayEndTimeStamp uint64, bidSignature []byte, slashAmt *big.Int, zkProof []*big.Int) (*types.Transaction, error) {
	return _Preconfmanager.Contract.OpenCommitment(&_Preconfmanager.TransactOpts, unopenedCommitmentIndex, bidAmt, blockNumber, txnHash, revertingTxHashes, decayStartTimeStamp, decayEndTimeStamp, bidSignature, slashAmt, zkProof)
}
