...
// MAXSLASHBIDRATIO is a free data retrieval call binding the contract method 0xa924593a.
//
// Solidity: function MAX_SLASH_BID_RATIO() view returns(uint256)
func (_Preconfmanager *PreconfmanagerCaller) MAXSLASHBIDRATIO(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "MAX_SLASH_BID_RATIO")
...
//
// Solidity: function MAX_SLASH_BID_RATIO() view returns(uint256)
func (_Preconfmanager *PreconfmanagerSession) MAXSLASHBIDRATIO() (*big.Int, error) {
	return _Preconfmanager.Contract.MAXSLASHBIDRATIO(&_Preconfmanager.CallOpts)
}

// MAXSLASHBIDRATIO is a free data retrieval call binding the contract method 0xa924593a.
//
// Solidity: function MAX_SLASH_BID_RATIO() view returns(uint256)
func (_Preconfmanager *PreconfmanagerCallerSession) MAXSLASHBIDRATIO() (*big.Int, error) {
	return _Preconfmanager.Contract.MAXSLASHBIDRATIO(&_Preconfmanager.CallOpts)
}
...
// GetBidHash is a free data retrieval call binding the contract method 0x95d5d5aa.
//
// Solidity: function getBidHash((bytes32,uint256,uint256,uint64,uint64,uint64,string,string,bytes,uint256[],bytes) params) view returns(bytes32)
...
//
// Solidity: function getCommitment(bytes32 commitmentIndex) view returns((address,bool,uint64,uint64,uint64,uint64,address,uint256,uint256,bytes32,bytes,string,string,bytes))
...
// GetOpenedCommitmentIndex is a free data retrieval call binding the contract method 0x5903c647.
//
// Solidity: function getOpenedCommitmentIndex((address,bool,uint64,uint64,uint64,uint64,address,uint256,uint256,bytes32,bytes,string,string,bytes) commitment) pure returns(bytes32)
...
func (_Preconfmanager *PreconfmanagerCaller) OpenedCommitments(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	outstruct.BidOptions = *abi.ConvertType(out[13], new([]byte)).(*[]byte)
...
// VerifyBid is a free data retrieval call binding the contract method 0xd9848726.
//
// Solidity: function verifyBid((bytes32,uint256,uint256,uint64,uint64,uint64,string,string,bytes,uint256[],bytes) params) view returns(bytes32 messageDigest, address recoveredAddress)
...
// OpenCommitment is a paid mutator transaction binding the contract method 0xee20a6fb.
//
// Solidity: function openCommitment((bytes32,uint256,uint256,uint64,uint64,uint64,string,string,bytes,uint256[],bytes) params) returns(bytes32 commitmentIndex)
...
// FilterOpenedCommitmentStored is a free log retrieval operation binding the contract event 0xb71cdedc4cf5c26e95090c52d1ede759c017aef182298b15f65dcf4d2f67b1f6.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint256 slashAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, uint64 dispatchTimestamp, bytes bidOptions)
...
// WatchOpenedCommitmentStored is a free log subscription operation binding the contract event 0xb71cdedc4cf5c26e95090c52d1ede759c017aef182298b15f65dcf4d2f67b1f6.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint256 slashAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, uint64 dispatchTimestamp, bytes bidOptions)
...
// ParseOpenedCommitmentStored is a log parse operation binding the contract event 0xb71cdedc4cf5c26e95090c52d1ede759c017aef182298b15f65dcf4d2f67b1f6.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint256 slashAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, uint64 dispatchTimestamp, bytes bidOptions)
