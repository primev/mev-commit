...
// VerifyPreConfCommitment is a free data retrieval call binding the contract method 0xd4a91efb.
//
// Solidity: function verifyPreConfCommitment((string,string,uint256,uint64,uint64,uint64,bytes32,bytes,bytes,bytes,uint256[]) params) view returns(bytes32 preConfHash, address committerAddress)
