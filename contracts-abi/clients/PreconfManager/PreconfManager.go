...
// GetBidHash is a free data retrieval call binding the contract method 0xa52b1613.
//
// Solidity: function getBidHash((bytes32,uint256,uint64,string,string,uint64,uint64,bytes,uint256,uint256[]) params) view returns(bytes32)
...
// VerifyBid is a free data retrieval call binding the contract method 0x1185806f.
//
// Solidity: function verifyBid((bytes32,uint256,uint64,string,string,uint64,uint64,bytes,uint256,uint256[]) params) view returns(bytes32 messageDigest, address recoveredAddress)
...
// OpenCommitment is a paid mutator transaction binding the contract method 0xbe0e3dab.
//
// Solidity: function openCommitment((bytes32,uint256,uint64,string,string,uint64,uint64,bytes,uint256,uint256[]) params) returns(bytes32 commitmentIndex)
