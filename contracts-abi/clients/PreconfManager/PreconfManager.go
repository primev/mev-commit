...
// GetBidHash is a free data retrieval call binding the contract method 0xc3325c36.
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCaller) GetBidHash(opts *bind.CallOpts, _txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "getBidHash", _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount)
...
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerSession) GetBidHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int) ([32]byte, error) {
	return _Preconfmanager.Contract.GetBidHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount)
}

// GetBidHash is a free data retrieval call binding the contract method 0xc3325c36.
//
// Solidity: function getBidHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCallerSession) GetBidHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int) ([32]byte, error) {
	return _Preconfmanager.Contract.GetBidHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount)
}

// GetCommitment is a free data retrieval call binding the contract method 0x7795820c.
//
// Solidity: function getCommitment(bytes32 commitmentIndex) view returns((address,bool,uint64,uint64,uint64,uint256,uint64,address,uint256,bytes32,bytes32,bytes,bytes,bytes,string,string))
...
// GetOpenedCommitmentIndex is a free data retrieval call binding the contract method 0xb1494dd6.
//
// Solidity: function getOpenedCommitmentIndex((address,bool,uint64,uint64,uint64,uint256,uint64,address,uint256,bytes32,bytes32,bytes,bytes,bytes,string,string) commitment) pure returns(bytes32)
...
// GetPreConfHash is a free data retrieval call binding the contract method 0xc075ceba.
//
// Solidity: function getPreConfHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount, bytes32 _bidHash, bytes _bidSignature, bytes _sharedSecretKey) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCaller) GetPreConfHash(opts *bind.CallOpts, _txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int, _bidHash [32]byte, _bidSignature []byte, _sharedSecretKey []byte) ([32]byte, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "getPreConfHash", _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount, _bidHash, _bidSignature, _sharedSecretKey)
...
//
// Solidity: function getPreConfHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount, bytes32 _bidHash, bytes _bidSignature, bytes _sharedSecretKey) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerSession) GetPreConfHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int, _bidHash [32]byte, _bidSignature []byte, _sharedSecretKey []byte) ([32]byte, error) {
	return _Preconfmanager.Contract.GetPreConfHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount, _bidHash, _bidSignature, _sharedSecretKey)
}

// GetPreConfHash is a free data retrieval call binding the contract method 0xc075ceba.
//
// Solidity: function getPreConfHash(string _txnHash, string _revertingTxHashes, uint256 _bidAmt, uint64 _blockNumber, uint64 _decayStartTimeStamp, uint64 _decayEndTimeStamp, uint256 _slashAmount, bytes32 _bidHash, bytes _bidSignature, bytes _sharedSecretKey) view returns(bytes32)
func (_Preconfmanager *PreconfmanagerCallerSession) GetPreConfHash(_txnHash string, _revertingTxHashes string, _bidAmt *big.Int, _blockNumber uint64, _decayStartTimeStamp uint64, _decayEndTimeStamp uint64, _slashAmount *big.Int, _bidHash [32]byte, _bidSignature []byte, _sharedSecretKey []byte) ([32]byte, error) {
	return _Preconfmanager.Contract.GetPreConfHash(&_Preconfmanager.CallOpts, _txnHash, _revertingTxHashes, _bidAmt, _blockNumber, _decayStartTimeStamp, _decayEndTimeStamp, _slashAmount, _bidHash, _bidSignature, _sharedSecretKey)
}
...
//
// Solidity: function openedCommitments(bytes32 ) view returns(address bidder, bool isSettled, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, uint64 dispatchTimestamp, address committer, uint256 bidAmt, bytes32 bidHash, bytes32 commitmentDigest, bytes bidSignature, bytes commitmentSignature, bytes sharedSecretKey, string txnHash, string revertingTxHashes)
func (_Preconfmanager *PreconfmanagerCaller) OpenedCommitments(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	outstruct.SlashAmount = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.DispatchTimestamp = *abi.ConvertType(out[6], new(uint64)).(*uint64)
	outstruct.Committer = *abi.ConvertType(out[7], new(common.Address)).(*common.Address)
	outstruct.BidAmt = *abi.ConvertType(out[8], new(*big.Int)).(**big.Int)
	outstruct.BidHash = *abi.ConvertType(out[9], new([32]byte)).(*[32]byte)
	outstruct.CommitmentDigest = *abi.ConvertType(out[10], new([32]byte)).(*[32]byte)
	outstruct.BidSignature = *abi.ConvertType(out[11], new([]byte)).(*[]byte)
	outstruct.CommitmentSignature = *abi.ConvertType(out[12], new([]byte)).(*[]byte)
	outstruct.SharedSecretKey = *abi.ConvertType(out[13], new([]byte)).(*[]byte)
	outstruct.TxnHash = *abi.ConvertType(out[14], new(string)).(*string)
	outstruct.RevertingTxHashes = *abi.ConvertType(out[15], new(string)).(*string)
...
// VerifyBid is a free data retrieval call binding the contract method 0x5ec0545b.
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes bidSignature) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerCaller) VerifyBid(opts *bind.CallOpts, bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, slashAmount *big.Int, txnHash string, revertingTxHashes string, bidSignature []byte) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	var out []interface{}
	err := _Preconfmanager.contract.Call(opts, &out, "verifyBid", bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, slashAmount, txnHash, revertingTxHashes, bidSignature)
...
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes bidSignature) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerSession) VerifyBid(bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, slashAmount *big.Int, txnHash string, revertingTxHashes string, bidSignature []byte) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	return _Preconfmanager.Contract.VerifyBid(&_Preconfmanager.CallOpts, bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, slashAmount, txnHash, revertingTxHashes, bidSignature)
}

// VerifyBid is a free data retrieval call binding the contract method 0x5ec0545b.
//
// Solidity: function verifyBid(uint256 bidAmt, uint64 blockNumber, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes bidSignature) view returns(bytes32 messageDigest, address recoveredAddress)
func (_Preconfmanager *PreconfmanagerCallerSession) VerifyBid(bidAmt *big.Int, blockNumber uint64, decayStartTimeStamp uint64, decayEndTimeStamp uint64, slashAmount *big.Int, txnHash string, revertingTxHashes string, bidSignature []byte) (struct {
	MessageDigest    [32]byte
	RecoveredAddress common.Address
}, error) {
	return _Preconfmanager.Contract.VerifyBid(&_Preconfmanager.CallOpts, bidAmt, blockNumber, decayStartTimeStamp, decayEndTimeStamp, slashAmount, txnHash, revertingTxHashes, bidSignature)
...
// VerifyPreConfCommitment is a free data retrieval call binding the contract method 0xecf2f074.
//
// Solidity: function verifyPreConfCommitment((string,string,uint256,uint64,uint64,uint64,uint256,bytes32,bytes,bytes,bytes) params) view returns(bytes32 preConfHash, address committerAddress)
...
// OpenCommitment is a paid mutator transaction binding the contract method 0x68656a63.
//
// Solidity: function openCommitment((bytes32,uint256,uint64,string,string,uint64,uint64,uint256,bytes,bytes) params) returns(bytes32 commitmentIndex)
...
// FilterOpenedCommitmentStored is a free log retrieval operation binding the contract event 0x354e1c46af64083e1c068d751e36d564b3a580d8c2ac269ec0f2254a052390e5.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint64 blockNumber, bytes32 bidHash, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, bytes bidSignature, bytes commitmentSignature, uint64 dispatchTimestamp, bytes sharedSecretKey)
...
// WatchOpenedCommitmentStored is a free log subscription operation binding the contract event 0x354e1c46af64083e1c068d751e36d564b3a580d8c2ac269ec0f2254a052390e5.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint64 blockNumber, bytes32 bidHash, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, bytes bidSignature, bytes commitmentSignature, uint64 dispatchTimestamp, bytes sharedSecretKey)
...
// ParseOpenedCommitmentStored is a log parse operation binding the contract event 0x354e1c46af64083e1c068d751e36d564b3a580d8c2ac269ec0f2254a052390e5.
//
// Solidity: event OpenedCommitmentStored(bytes32 indexed commitmentIndex, address bidder, address committer, uint256 bidAmt, uint64 blockNumber, bytes32 bidHash, uint64 decayStartTimeStamp, uint64 decayEndTimeStamp, uint256 slashAmount, string txnHash, string revertingTxHashes, bytes32 commitmentDigest, bytes bidSignature, bytes commitmentSignature, uint64 dispatchTimestamp, bytes sharedSecretKey)
...
// FilterSignatureVerified is a free log retrieval operation binding the contract event 0xd680a060c45752f3cf03d0272adc8a6d6bd28b56f465e2363442b5cc59903cf2.
//
// Solidity: event SignatureVerified(address indexed signer, string txnHash, string revertingTxHashes, uint256 indexed bidAmt, uint256 slashAmount, uint64 blockNumber)
...
// WatchSignatureVerified is a free log subscription operation binding the contract event 0xd680a060c45752f3cf03d0272adc8a6d6bd28b56f465e2363442b5cc59903cf2.
//
// Solidity: event SignatureVerified(address indexed signer, string txnHash, string revertingTxHashes, uint256 indexed bidAmt, uint256 slashAmount, uint64 blockNumber)
...
// ParseSignatureVerified is a log parse operation binding the contract event 0xd680a060c45752f3cf03d0272adc8a6d6bd28b56f465e2363442b5cc59903cf2.
//
// Solidity: event SignatureVerified(address indexed signer, string txnHash, string revertingTxHashes, uint256 indexed bidAmt, uint256 slashAmount, uint64 blockNumber)
