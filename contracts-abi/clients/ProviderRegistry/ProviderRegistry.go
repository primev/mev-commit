...
//
// Solidity: function areProvidersValid(address[] providers) view returns(bool[])
func (_Providerregistry *ProviderregistryCaller) AreProvidersValid(opts *bind.CallOpts, providers []common.Address) ([]bool, error) {
	var out []interface{}
	err := _Providerregistry.contract.Call(opts, &out, "areProvidersValid", providers)
...
//
// Solidity: function areProvidersValid(address[] providers) view returns(bool[])
func (_Providerregistry *ProviderregistrySession) AreProvidersValid(providers []common.Address) ([]bool, error) {
	return _Providerregistry.Contract.AreProvidersValid(&_Providerregistry.CallOpts, providers)
}

// AreProvidersValid is a free data retrieval call binding the contract method 0x8dc4ce17.
//
// Solidity: function areProvidersValid(address[] providers) view returns(bool[])
func (_Providerregistry *ProviderregistryCallerSession) AreProvidersValid(providers []common.Address) ([]bool, error) {
	return _Providerregistry.Contract.AreProvidersValid(&_Providerregistry.CallOpts, providers)
}
...
// OverrideRemoveBLSKey is a paid mutator transaction binding the contract method 0x52f3a20b.
//
// Solidity: function overrideRemoveBLSKey(address provider, bytes blsPublicKey) returns()
func (_Providerregistry *ProviderregistryTransactor) OverrideRemoveBLSKey(opts *bind.TransactOpts, provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "overrideRemoveBLSKey", provider, blsPublicKey)
}

// OverrideRemoveBLSKey is a paid mutator transaction binding the contract method 0x52f3a20b.
//
// Solidity: function overrideRemoveBLSKey(address provider, bytes blsPublicKey) returns()
func (_Providerregistry *ProviderregistrySession) OverrideRemoveBLSKey(provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.Contract.OverrideRemoveBLSKey(&_Providerregistry.TransactOpts, provider, blsPublicKey)
}

// OverrideRemoveBLSKey is a paid mutator transaction binding the contract method 0x52f3a20b.
//
// Solidity: function overrideRemoveBLSKey(address provider, bytes blsPublicKey) returns()
func (_Providerregistry *ProviderregistryTransactorSession) OverrideRemoveBLSKey(provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.Contract.OverrideRemoveBLSKey(&_Providerregistry.TransactOpts, provider, blsPublicKey)
}
...
//
// Solidity: function slash(uint256 slashAmt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistryTransactor) Slash(opts *bind.TransactOpts, slashAmt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "slash", slashAmt, provider, bidder)
}

// Slash is a paid mutator transaction binding the contract method 0xbe995dc2.
//
// Solidity: function slash(uint256 slashAmt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistrySession) Slash(slashAmt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, slashAmt, provider, bidder)
}

// Slash is a paid mutator transaction binding the contract method 0xbe995dc2.
//
// Solidity: function slash(uint256 slashAmt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistryTransactorSession) Slash(slashAmt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, slashAmt, provider, bidder)
}
...
// ProviderregistryBLSKeyRemovedIterator is returned from FilterBLSKeyRemoved and is used to iterate over the raw logs and unpacked data for BLSKeyRemoved events raised by the Providerregistry contract.
type ProviderregistryBLSKeyRemovedIterator struct {
	Event *ProviderregistryBLSKeyRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ProviderregistryBLSKeyRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ProviderregistryBLSKeyRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ProviderregistryBLSKeyRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ProviderregistryBLSKeyRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ProviderregistryBLSKeyRemoved represents a BLSKeyRemoved event raised by the Providerregistry contract.
type ProviderregistryBLSKeyRemoved struct {
	Provider     common.Address
	BlsPublicKey []byte
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterBLSKeyRemoved is a free log retrieval operation binding the contract event 0x2af0a07b5b153d8ba52468d4bfcea604ccce1c043e18082b36077b4baff2b8e6.
//
// Solidity: event BLSKeyRemoved(address indexed provider, bytes blsPublicKey)
func (_Providerregistry *ProviderregistryFilterer) FilterBLSKeyRemoved(opts *bind.FilterOpts, provider []common.Address) (*ProviderregistryBLSKeyRemovedIterator, error) {
	...
	logs, sub, err := _Providerregistry.contract.FilterLogs(opts, "BLSKeyRemoved", providerRule)
	if err != nil {
		return nil, err
	}
	return &ProviderregistryBLSKeyRemovedIterator{contract: _Providerregistry.contract, event: "BLSKeyRemoved", logs: logs, sub: sub}, nil
}

// WatchBLSKeyRemoved is a free log subscription operation binding the contract event 0x2af0a07b5b153d8ba52468d4bfcea604ccce1c043e18082b36077b4baff2b8e6.
//
// Solidity: event BLSKeyRemoved(address indexed provider, bytes blsPublicKey)
func (_Providerregistry *ProviderregistryFilterer) WatchBLSKeyRemoved(opts *bind.WatchOpts, sink chan<- *ProviderregistryBLSKeyRemoved, provider []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Providerregistry.contract.WatchLogs(opts, "BLSKeyRemoved", providerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ProviderregistryBLSKeyRemoved)
				if err := _Providerregistry.contract.UnpackLog(event, "BLSKeyRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBLSKeyRemoved is a log parse operation binding the contract event 0x2af0a07b5b153d8ba52468d4bfcea604ccce1c043e18082b36077b4baff2b8e6.
//
// Solidity: event BLSKeyRemoved(address indexed provider, bytes blsPublicKey)
func (_Providerregistry *ProviderregistryFilterer) ParseBLSKeyRemoved(log types.Log) (*ProviderregistryBLSKeyRemoved, error) {
	event := new(ProviderregistryBLSKeyRemoved)
	if err := _Providerregistry.contract.UnpackLog(event, "BLSKeyRemoved", log); err != nil {
		return nil, err
	}
...
//
// Solidity: event InsufficientFundsToSlash(address indexed provider, uint256 providerStake, uint256 penaltyFee, uint256 bidderPortion)
