...
// BidderWithdraw is a paid mutator transaction binding the contract method 0x71cf82d3.
//
// Solidity: function bidderWithdraw() returns()
func (_Providerregistry *ProviderregistryTransactor) BidderWithdraw(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "bidderWithdraw")
}

// BidderWithdraw is a paid mutator transaction binding the contract method 0x71cf82d3.
//
// Solidity: function bidderWithdraw() returns()
func (_Providerregistry *ProviderregistrySession) BidderWithdraw() (*types.Transaction, error) {
	return _Providerregistry.Contract.BidderWithdraw(&_Providerregistry.TransactOpts)
}

// BidderWithdraw is a paid mutator transaction binding the contract method 0x71cf82d3.
//
// Solidity: function bidderWithdraw() returns()
func (_Providerregistry *ProviderregistryTransactorSession) BidderWithdraw() (*types.Transaction, error) {
	return _Providerregistry.Contract.BidderWithdraw(&_Providerregistry.TransactOpts)
}
