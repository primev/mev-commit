...
// ProviderregistryBidderWithdrawalIterator is returned from FilterBidderWithdrawal and is used to iterate over the raw logs and unpacked data for BidderWithdrawal events raised by the Providerregistry contract.
type ProviderregistryBidderWithdrawalIterator struct {
	Event *ProviderregistryBidderWithdrawal // Event containing the contract specifics and raw log
...
func (it *ProviderregistryBidderWithdrawalIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ProviderregistryBidderWithdrawal)
...
func (it *ProviderregistryBidderWithdrawalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ProviderregistryBidderWithdrawalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ProviderregistryBidderWithdrawal represents a BidderWithdrawal event raised by the Providerregistry contract.
type ProviderregistryBidderWithdrawal struct {
	Bidder common.Address
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterBidderWithdrawal is a free log retrieval operation binding the contract event 0xc8e31b8698d76c27ba585fb0b0926b1f6c8eb460135f8c398eb178561ff1e798.
//
// Solidity: event BidderWithdrawal(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) FilterBidderWithdrawal(opts *bind.FilterOpts) (*ProviderregistryBidderWithdrawalIterator, error) {

	logs, sub, err := _Providerregistry.contract.FilterLogs(opts, "BidderWithdrawal")
	if err != nil {
		return nil, err
	}
	return &ProviderregistryBidderWithdrawalIterator{contract: _Providerregistry.contract, event: "BidderWithdrawal", logs: logs, sub: sub}, nil
}

// WatchBidderWithdrawal is a free log subscription operation binding the contract event 0xc8e31b8698d76c27ba585fb0b0926b1f6c8eb460135f8c398eb178561ff1e798.
//
// Solidity: event BidderWithdrawal(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) WatchBidderWithdrawal(opts *bind.WatchOpts, sink chan<- *ProviderregistryBidderWithdrawal) (event.Subscription, error) {

	logs, sub, err := _Providerregistry.contract.WatchLogs(opts, "BidderWithdrawal")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ProviderregistryBidderWithdrawal)
				if err := _Providerregistry.contract.UnpackLog(event, "BidderWithdrawal", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBidderWithdrawal is a log parse operation binding the contract event 0xc8e31b8698d76c27ba585fb0b0926b1f6c8eb460135f8c398eb178561ff1e798.
//
// Solidity: event BidderWithdrawal(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) ParseBidderWithdrawal(log types.Log) (*ProviderregistryBidderWithdrawal, error) {
	event := new(ProviderregistryBidderWithdrawal)
	if err := _Providerregistry.contract.UnpackLog(event, "BidderWithdrawal", log); err != nil {
		return nil, err
	}
