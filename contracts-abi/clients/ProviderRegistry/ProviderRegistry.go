...
// BlsPubkeyToEoa is a free data retrieval call binding the contract method 0x366d28a4.
//
// Solidity: function blsPubkeyToEoa(bytes ) view returns(address)
func (_Providerregistry *ProviderregistryCaller) BlsPubkeyToEoa(opts *bind.CallOpts, arg0 []byte) (common.Address, error) {
	var out []interface{}
	err := _Providerregistry.contract.Call(opts, &out, "blsPubkeyToEoa", arg0)
...
//
// Solidity: function blsPubkeyToEoa(bytes ) view returns(address)
func (_Providerregistry *ProviderregistrySession) BlsPubkeyToEoa(arg0 []byte) (common.Address, error) {
	return _Providerregistry.Contract.BlsPubkeyToEoa(&_Providerregistry.CallOpts, arg0)
}

// BlsPubkeyToEoa is a free data retrieval call binding the contract method 0x366d28a4.
//
// Solidity: function blsPubkeyToEoa(bytes ) view returns(address)
func (_Providerregistry *ProviderregistryCallerSession) BlsPubkeyToEoa(arg0 []byte) (common.Address, error) {
	return _Providerregistry.Contract.BlsPubkeyToEoa(&_Providerregistry.CallOpts, arg0)
}
