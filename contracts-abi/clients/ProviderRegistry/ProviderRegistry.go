...
//
// Solidity: event FeeTransfer(uint256 amount, address recipient)
func (_Providerregistry *ProviderregistryFilterer) FilterFeeTransfer(opts *bind.FilterOpts) (*ProviderregistryFeeTransferIterator, error) {

	logs, sub, err := _Providerregistry.contract.FilterLogs(opts, "FeeTransfer")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event FeeTransfer(uint256 amount, address recipient)
func (_Providerregistry *ProviderregistryFilterer) WatchFeeTransfer(opts *bind.WatchOpts, sink chan<- *ProviderregistryFeeTransfer) (event.Subscription, error) {

	logs, sub, err := _Providerregistry.contract.WatchLogs(opts, "FeeTransfer")
	if err != nil {
		return nil, err
	}
