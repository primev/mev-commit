...
// DelegateRegisterAndStake is a paid mutator transaction binding the contract method 0x05191b89.
//
// Solidity: function delegateRegisterAndStake(address provider, bytes blsPublicKey) payable returns()
func (_Providerregistry *ProviderregistryTransactor) DelegateRegisterAndStake(opts *bind.TransactOpts, provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "delegateRegisterAndStake", provider, blsPublicKey)
}

// DelegateRegisterAndStake is a paid mutator transaction binding the contract method 0x05191b89.
//
// Solidity: function delegateRegisterAndStake(address provider, bytes blsPublicKey) payable returns()
func (_Providerregistry *ProviderregistrySession) DelegateRegisterAndStake(provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.Contract.DelegateRegisterAndStake(&_Providerregistry.TransactOpts, provider, blsPublicKey)
}

// DelegateRegisterAndStake is a paid mutator transaction binding the contract method 0x05191b89.
//
// Solidity: function delegateRegisterAndStake(address provider, bytes blsPublicKey) payable returns()
func (_Providerregistry *ProviderregistryTransactorSession) DelegateRegisterAndStake(provider common.Address, blsPublicKey []byte) (*types.Transaction, error) {
	return _Providerregistry.Contract.DelegateRegisterAndStake(&_Providerregistry.TransactOpts, provider, blsPublicKey)
}
...
//
// Solidity: function slash(uint256 amt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistryTransactor) Slash(opts *bind.TransactOpts, amt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "slash", amt, provider, bidder)
}

// Slash is a paid mutator transaction binding the contract method 0xbe995dc2.
//
// Solidity: function slash(uint256 amt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistrySession) Slash(amt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, provider, bidder)
}

// Slash is a paid mutator transaction binding the contract method 0xbe995dc2.
//
// Solidity: function slash(uint256 amt, address provider, address bidder) returns()
func (_Providerregistry *ProviderregistryTransactorSession) Slash(amt *big.Int, provider common.Address, bidder common.Address) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, provider, bidder)
}
...
// ProviderregistryBidderWithdrawalSlashedIterator is returned from FilterBidderWithdrawalSlashed and is used to iterate over the raw logs and unpacked data for BidderWithdrawalSlashed events raised by the Providerregistry contract.
type ProviderregistryBidderWithdrawalSlashedIterator struct {
	Event *ProviderregistryBidderWithdrawalSlashed // Event containing the contract specifics and raw log
...
func (it *ProviderregistryBidderWithdrawalSlashedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ProviderregistryBidderWithdrawalSlashed)
...
func (it *ProviderregistryBidderWithdrawalSlashedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ProviderregistryBidderWithdrawalSlashedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ProviderregistryBidderWithdrawalSlashed represents a BidderWithdrawalSlashed event raised by the Providerregistry contract.
type ProviderregistryBidderWithdrawalSlashed struct {
	Bidder common.Address
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterBidderWithdrawalSlashed is a free log retrieval operation binding the contract event 0x3b057838bed172d7eb0e983df3a54006910cb330f822b73998fdba1803a39cf2.
//
// Solidity: event BidderWithdrawalSlashed(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) FilterBidderWithdrawalSlashed(opts *bind.FilterOpts) (*ProviderregistryBidderWithdrawalSlashedIterator, error) {

	logs, sub, err := _Providerregistry.contract.FilterLogs(opts, "BidderWithdrawalSlashed")
	if err != nil {
		return nil, err
	}
	return &ProviderregistryBidderWithdrawalSlashedIterator{contract: _Providerregistry.contract, event: "BidderWithdrawalSlashed", logs: logs, sub: sub}, nil
}

// WatchBidderWithdrawalSlashed is a free log subscription operation binding the contract event 0x3b057838bed172d7eb0e983df3a54006910cb330f822b73998fdba1803a39cf2.
//
// Solidity: event BidderWithdrawalSlashed(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) WatchBidderWithdrawalSlashed(opts *bind.WatchOpts, sink chan<- *ProviderregistryBidderWithdrawalSlashed) (event.Subscription, error) {

	logs, sub, err := _Providerregistry.contract.WatchLogs(opts, "BidderWithdrawalSlashed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ProviderregistryBidderWithdrawalSlashed)
				if err := _Providerregistry.contract.UnpackLog(event, "BidderWithdrawalSlashed", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBidderWithdrawalSlashed is a log parse operation binding the contract event 0x3b057838bed172d7eb0e983df3a54006910cb330f822b73998fdba1803a39cf2.
//
// Solidity: event BidderWithdrawalSlashed(address bidder, uint256 amount)
func (_Providerregistry *ProviderregistryFilterer) ParseBidderWithdrawalSlashed(log types.Log) (*ProviderregistryBidderWithdrawalSlashed, error) {
	event := new(ProviderregistryBidderWithdrawalSlashed)
	if err := _Providerregistry.contract.UnpackLog(event, "BidderWithdrawalSlashed", log); err != nil {
		return nil, err
	}
...
func (_Providerregistry *ProviderregistryFilterer) FilterFeePercentUpdated(opts *bind.FilterOpts, newFeePercent []uint16) (*ProviderregistryFeePercentUpdatedIterator, error) {
...
//
// Solidity: event FeePercentUpdated(uint16 indexed newFeePercent)
func (_Providerregistry *ProviderregistryFilterer) WatchFeePercentUpdated(opts *bind.WatchOpts, sink chan<- *ProviderregistryFeePercentUpdated, newFeePercent []uint16) (event.Subscription, error) {
