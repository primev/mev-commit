...
//
// Solidity: function slash(uint256 amt, uint256 slashAmount, address provider, address bidder, uint256 residualBidPercentAfterDecay) returns()
func (_Providerregistry *ProviderregistryTransactor) Slash(opts *bind.TransactOpts, amt *big.Int, slashAmount *big.Int, provider common.Address, bidder common.Address, residualBidPercentAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.contract.Transact(opts, "slash", amt, slashAmount, provider, bidder, residualBidPercentAfterDecay)
}

// Slash is a paid mutator transaction binding the contract method 0x76ddeafc.
//
// Solidity: function slash(uint256 amt, uint256 slashAmount, address provider, address bidder, uint256 residualBidPercentAfterDecay) returns()
func (_Providerregistry *ProviderregistrySession) Slash(amt *big.Int, slashAmount *big.Int, provider common.Address, bidder common.Address, residualBidPercentAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, slashAmount, provider, bidder, residualBidPercentAfterDecay)
}

// Slash is a paid mutator transaction binding the contract method 0x76ddeafc.
//
// Solidity: function slash(uint256 amt, uint256 slashAmount, address provider, address bidder, uint256 residualBidPercentAfterDecay) returns()
func (_Providerregistry *ProviderregistryTransactorSession) Slash(amt *big.Int, slashAmount *big.Int, provider common.Address, bidder common.Address, residualBidPercentAfterDecay *big.Int) (*types.Transaction, error) {
	return _Providerregistry.Contract.Slash(&_Providerregistry.TransactOpts, amt, slashAmount, provider, bidder, residualBidPercentAfterDecay)
}
...
//
// Solidity: event InsufficientFundsToSlash(address indexed provider, uint256 providerStake, uint256 residualAmount, uint256 penaltyFee, uint256 slashAmount)
