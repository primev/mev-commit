...
// EXECUTESLASHPHASEDURATIONSECONDS is a free data retrieval call binding the contract method 0xe0ed7da3.
//
// Solidity: function EXECUTE_SLASH_PHASE_DURATION_SECONDS() view returns(uint256)
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) EXECUTESLASHPHASEDURATIONSECONDS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Mevcommitmiddleware.contract.Call(opts, &out, "EXECUTE_SLASH_PHASE_DURATION_SECONDS")
...
//
// Solidity: function EXECUTE_SLASH_PHASE_DURATION_SECONDS() view returns(uint256)
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) EXECUTESLASHPHASEDURATIONSECONDS() (*big.Int, error) {
	return _Mevcommitmiddleware.Contract.EXECUTESLASHPHASEDURATIONSECONDS(&_Mevcommitmiddleware.CallOpts)
}

// EXECUTESLASHPHASEDURATIONSECONDS is a free data retrieval call binding the contract method 0xe0ed7da3.
//
// Solidity: function EXECUTE_SLASH_PHASE_DURATION_SECONDS() view returns(uint256)
func (_Mevcommitmiddleware *MevcommitmiddlewareCallerSession) EXECUTESLASHPHASEDURATIONSECONDS() (*big.Int, error) {
	return _Mevcommitmiddleware.Contract.EXECUTESLASHPHASEDURATIONSECONDS(&_Mevcommitmiddleware.CallOpts)
}
...
//
// Solidity: function slashRecords(address vault, address operator, uint256 blockNumber) view returns(bool exists, uint256 numSlashed, uint256 numInitSlashableRegistered)
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) SlashRecords(opts *bind.CallOpts, vault common.Address, operator common.Address, blockNumber *big.Int) (struct {
	...
	outstruct.NumInitSlashableRegistered = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
...
// ExecuteSlashes is a paid mutator transaction binding the contract method 0xbd7e98c5.
//
// Solidity: function executeSlashes(bytes[] blsPubkeys, uint256[] slashIndexes) returns(uint256[] slashedAmounts)
func (_Mevcommitmiddleware *MevcommitmiddlewareTransactor) ExecuteSlashes(opts *bind.TransactOpts, blsPubkeys [][]byte, slashIndexes []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.contract.Transact(opts, "executeSlashes", blsPubkeys, slashIndexes)
}

// ExecuteSlashes is a paid mutator transaction binding the contract method 0xbd7e98c5.
//
// Solidity: function executeSlashes(bytes[] blsPubkeys, uint256[] slashIndexes) returns(uint256[] slashedAmounts)
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) ExecuteSlashes(blsPubkeys [][]byte, slashIndexes []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.Contract.ExecuteSlashes(&_Mevcommitmiddleware.TransactOpts, blsPubkeys, slashIndexes)
}

// ExecuteSlashes is a paid mutator transaction binding the contract method 0xbd7e98c5.
//
// Solidity: function executeSlashes(bytes[] blsPubkeys, uint256[] slashIndexes) returns(uint256[] slashedAmounts)
func (_Mevcommitmiddleware *MevcommitmiddlewareTransactorSession) ExecuteSlashes(blsPubkeys [][]byte, slashIndexes []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.Contract.ExecuteSlashes(&_Mevcommitmiddleware.TransactOpts, blsPubkeys, slashIndexes)
}
...
// RegisterVaults is a paid mutator transaction binding the contract method 0x198a459d.
//
// Solidity: function registerVaults(address[] vaults, uint256[] slashAmounts) returns()
...
//
// Solidity: function slashValidators(bytes[] blsPubkeys, uint256[] infractionTimestamps) returns()
func (_Mevcommitmiddleware *MevcommitmiddlewareTransactor) SlashValidators(opts *bind.TransactOpts, blsPubkeys [][]byte, infractionTimestamps []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.contract.Transact(opts, "slashValidators", blsPubkeys, infractionTimestamps)
}

// SlashValidators is a paid mutator transaction binding the contract method 0xf62f76fa.
//
// Solidity: function slashValidators(bytes[] blsPubkeys, uint256[] infractionTimestamps) returns()
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) SlashValidators(blsPubkeys [][]byte, infractionTimestamps []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.Contract.SlashValidators(&_Mevcommitmiddleware.TransactOpts, blsPubkeys, infractionTimestamps)
}

// SlashValidators is a paid mutator transaction binding the contract method 0xf62f76fa.
//
// Solidity: function slashValidators(bytes[] blsPubkeys, uint256[] infractionTimestamps) returns()
func (_Mevcommitmiddleware *MevcommitmiddlewareTransactorSession) SlashValidators(blsPubkeys [][]byte, infractionTimestamps []*big.Int) (*types.Transaction, error) {
	return _Mevcommitmiddleware.Contract.SlashValidators(&_Mevcommitmiddleware.TransactOpts, blsPubkeys, infractionTimestamps)
}
...
// UpdateSlashAmounts is a paid mutator transaction binding the contract method 0xa471324a.
//
// Solidity: function updateSlashAmounts(address[] vaults, uint256[] slashAmounts) returns()
...
// MevcommitmiddlewareValidatorSlashRequestedIterator is returned from FilterValidatorSlashRequested and is used to iterate over the raw logs and unpacked data for ValidatorSlashRequested events raised by the Mevcommitmiddleware contract.
type MevcommitmiddlewareValidatorSlashRequestedIterator struct {
	Event *MevcommitmiddlewareValidatorSlashRequested // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MevcommitmiddlewareValidatorSlashRequestedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MevcommitmiddlewareValidatorSlashRequested)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MevcommitmiddlewareValidatorSlashRequestedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MevcommitmiddlewareValidatorSlashRequestedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MevcommitmiddlewareValidatorSlashRequested represents a ValidatorSlashRequested event raised by the Mevcommitmiddleware contract.
type MevcommitmiddlewareValidatorSlashRequested struct {
	BlsPubkey  []byte
	Operator   common.Address
	Vault      common.Address
	SlashIndex *big.Int
...
// FilterValidatorSlashRequested is a free log retrieval operation binding the contract event 0x74361cecbb52b793cb4c952fb5277f98e0a0736bbea69c3156602122db70c1ef.
//
// Solidity: event ValidatorSlashRequested(bytes blsPubkey, address indexed operator, address indexed vault, uint256 slashIndex)
func (_Mevcommitmiddleware *MevcommitmiddlewareFilterer) FilterValidatorSlashRequested(opts *bind.FilterOpts, operator []common.Address, vault []common.Address) (*MevcommitmiddlewareValidatorSlashRequestedIterator, error) {
	...
	logs, sub, err := _Mevcommitmiddleware.contract.FilterLogs(opts, "ValidatorSlashRequested", operatorRule, vaultRule)
	if err != nil {
		return nil, err
	}
	return &MevcommitmiddlewareValidatorSlashRequestedIterator{contract: _Mevcommitmiddleware.contract, event: "ValidatorSlashRequested", logs: logs, sub: sub}, nil
}

// WatchValidatorSlashRequested is a free log subscription operation binding the contract event 0x74361cecbb52b793cb4c952fb5277f98e0a0736bbea69c3156602122db70c1ef.
//
// Solidity: event ValidatorSlashRequested(bytes blsPubkey, address indexed operator, address indexed vault, uint256 slashIndex)
func (_Mevcommitmiddleware *MevcommitmiddlewareFilterer) WatchValidatorSlashRequested(opts *bind.WatchOpts, sink chan<- *MevcommitmiddlewareValidatorSlashRequested, operator []common.Address, vault []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mevcommitmiddleware.contract.WatchLogs(opts, "ValidatorSlashRequested", operatorRule, vaultRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MevcommitmiddlewareValidatorSlashRequested)
				if err := _Mevcommitmiddleware.contract.UnpackLog(event, "ValidatorSlashRequested", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseValidatorSlashRequested is a log parse operation binding the contract event 0x74361cecbb52b793cb4c952fb5277f98e0a0736bbea69c3156602122db70c1ef.
//
// Solidity: event ValidatorSlashRequested(bytes blsPubkey, address indexed operator, address indexed vault, uint256 slashIndex)
func (_Mevcommitmiddleware *MevcommitmiddlewareFilterer) ParseValidatorSlashRequested(log types.Log) (*MevcommitmiddlewareValidatorSlashRequested, error) {
	event := new(MevcommitmiddlewareValidatorSlashRequested)
	if err := _Mevcommitmiddleware.contract.UnpackLog(event, "ValidatorSlashRequested", log); err != nil {
		return nil, err
	}
...
// FilterVaultRegistered is a free log retrieval operation binding the contract event 0x2b4af7e743dba81c90a2926e49052c938a0e395da75c833e1e841c3d81f4567b.
//
// Solidity: event VaultRegistered(address indexed vault, uint256 slashAmount)
...
// WatchVaultRegistered is a free log subscription operation binding the contract event 0x2b4af7e743dba81c90a2926e49052c938a0e395da75c833e1e841c3d81f4567b.
//
// Solidity: event VaultRegistered(address indexed vault, uint256 slashAmount)
...
// ParseVaultRegistered is a log parse operation binding the contract event 0x2b4af7e743dba81c90a2926e49052c938a0e395da75c833e1e841c3d81f4567b.
//
// Solidity: event VaultRegistered(address indexed vault, uint256 slashAmount)
...
// FilterVaultSlashAmountUpdated is a free log retrieval operation binding the contract event 0xa43b55ce9604ad087eed36f199cf69cb986c743c6754148c288b4ce1500c42fa.
//
// Solidity: event VaultSlashAmountUpdated(address indexed vault, uint256 slashAmount)
...
// WatchVaultSlashAmountUpdated is a free log subscription operation binding the contract event 0xa43b55ce9604ad087eed36f199cf69cb986c743c6754148c288b4ce1500c42fa.
//
// Solidity: event VaultSlashAmountUpdated(address indexed vault, uint256 slashAmount)
...
// ParseVaultSlashAmountUpdated is a log parse operation binding the contract event 0xa43b55ce9604ad087eed36f199cf69cb986c743c6754148c288b4ce1500c42fa.
//
// Solidity: event VaultSlashAmountUpdated(address indexed vault, uint256 slashAmount)
