...
//
// Solidity: function slashRecords(address vault, address operator, uint256 blockNumber) view returns(bool exists, uint256 numSlashed, uint256 numInitSlashable)
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) SlashRecords(opts *bind.CallOpts, vault common.Address, operator common.Address, blockNumber *big.Int) (struct {
	...
	outstruct.NumInitSlashable = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
...
//
// Solidity: event SlashRecordCreated(address vault, address operator, uint256 blockNumber, uint256 numInitSlashable)
