...
// IMevCommitMiddlewareOperatorRecord is an auto generated low-level Go binding around an user-defined struct.
type IMevCommitMiddlewareOperatorRecord struct {
	DeregRequestHeight EventHeightLibEventHeight
	Exists             bool
	IsBlacklisted      bool
}

// IMevCommitMiddlewareValidatorRecord is an auto generated low-level Go binding around an user-defined struct.
type IMevCommitMiddlewareValidatorRecord struct {
...
// IMevCommitMiddlewareVaultRecord is an auto generated low-level Go binding around an user-defined struct.
type IMevCommitMiddlewareVaultRecord struct {
	Exists             bool
	DeregRequestHeight EventHeightLibEventHeight
	SlashAmount        *big.Int
}
...
// AllValidatorsAreSlashable is a free data retrieval call binding the contract method 0xae7dd276.
//
// Solidity: function allValidatorsAreSlashable(address vault, address operator) view returns(bool)
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) AllValidatorsAreSlashable(opts *bind.CallOpts, vault common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _Mevcommitmiddleware.contract.Call(opts, &out, "allValidatorsAreSlashable", vault, operator)
...
//
// Solidity: function allValidatorsAreSlashable(address vault, address operator) view returns(bool)
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) AllValidatorsAreSlashable(vault common.Address, operator common.Address) (bool, error) {
	return _Mevcommitmiddleware.Contract.AllValidatorsAreSlashable(&_Mevcommitmiddleware.CallOpts, vault, operator)
}

// AllValidatorsAreSlashable is a free data retrieval call binding the contract method 0xae7dd276.
//
// Solidity: function allValidatorsAreSlashable(address vault, address operator) view returns(bool)
func (_Mevcommitmiddleware *MevcommitmiddlewareCallerSession) AllValidatorsAreSlashable(vault common.Address, operator common.Address) (bool, error) {
	return _Mevcommitmiddleware.Contract.AllValidatorsAreSlashable(&_Mevcommitmiddleware.CallOpts, vault, operator)
}

// GetOperatorRecord is a free data retrieval call binding the contract method 0x7e4543bd.
//
// Solidity: function getOperatorRecord(address operator) view returns(((bool,uint256),bool,bool))
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) GetOperatorRecord(opts *bind.CallOpts, operator common.Address) (IMevCommitMiddlewareOperatorRecord, error) {
	var out []interface{}
	err := _Mevcommitmiddleware.contract.Call(opts, &out, "getOperatorRecord", operator)

	if err != nil {
		return *new(IMevCommitMiddlewareOperatorRecord), err
	}

	out0 := *abi.ConvertType(out[0], new(IMevCommitMiddlewareOperatorRecord)).(*IMevCommitMiddlewareOperatorRecord)
...
//
// Solidity: function getOperatorRecord(address operator) view returns(((bool,uint256),bool,bool))
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) GetOperatorRecord(operator common.Address) (IMevCommitMiddlewareOperatorRecord, error) {
	return _Mevcommitmiddleware.Contract.GetOperatorRecord(&_Mevcommitmiddleware.CallOpts, operator)
}

// GetOperatorRecord is a free data retrieval call binding the contract method 0x7e4543bd.
//
// Solidity: function getOperatorRecord(address operator) view returns(((bool,uint256),bool,bool))
func (_Mevcommitmiddleware *MevcommitmiddlewareCallerSession) GetOperatorRecord(operator common.Address) (IMevCommitMiddlewareOperatorRecord, error) {
	return _Mevcommitmiddleware.Contract.GetOperatorRecord(&_Mevcommitmiddleware.CallOpts, operator)
}

// GetValidatorRecord is a free data retrieval call binding the contract method 0xf2ba1071.
//
// Solidity: function getValidatorRecord(bytes blsPubkey) view returns((address,address,bool,(bool,uint256)))
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) GetValidatorRecord(opts *bind.CallOpts, blsPubkey []byte) (IMevCommitMiddlewareValidatorRecord, error) {
	var out []interface{}
	err := _Mevcommitmiddleware.contract.Call(opts, &out, "getValidatorRecord", blsPubkey)

	if err != nil {
		return *new(IMevCommitMiddlewareValidatorRecord), err
	}

	out0 := *abi.ConvertType(out[0], new(IMevCommitMiddlewareValidatorRecord)).(*IMevCommitMiddlewareValidatorRecord)
...
//
// Solidity: function getValidatorRecord(bytes blsPubkey) view returns((address,address,bool,(bool,uint256)))
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) GetValidatorRecord(blsPubkey []byte) (IMevCommitMiddlewareValidatorRecord, error) {
	return _Mevcommitmiddleware.Contract.GetValidatorRecord(&_Mevcommitmiddleware.CallOpts, blsPubkey)
}

// GetValidatorRecord is a free data retrieval call binding the contract method 0xf2ba1071.
//
// Solidity: function getValidatorRecord(bytes blsPubkey) view returns((address,address,bool,(bool,uint256)))
func (_Mevcommitmiddleware *MevcommitmiddlewareCallerSession) GetValidatorRecord(blsPubkey []byte) (IMevCommitMiddlewareValidatorRecord, error) {
	return _Mevcommitmiddleware.Contract.GetValidatorRecord(&_Mevcommitmiddleware.CallOpts, blsPubkey)
}

// GetVaultRecord is a free data retrieval call binding the contract method 0xde4ce5f2.
//
// Solidity: function getVaultRecord(address vault) view returns((bool,(bool,uint256),uint256))
func (_Mevcommitmiddleware *MevcommitmiddlewareCaller) GetVaultRecord(opts *bind.CallOpts, vault common.Address) (IMevCommitMiddlewareVaultRecord, error) {
	var out []interface{}
	err := _Mevcommitmiddleware.contract.Call(opts, &out, "getVaultRecord", vault)

	if err != nil {
		return *new(IMevCommitMiddlewareVaultRecord), err
	}

	out0 := *abi.ConvertType(out[0], new(IMevCommitMiddlewareVaultRecord)).(*IMevCommitMiddlewareVaultRecord)
...
//
// Solidity: function getVaultRecord(address vault) view returns((bool,(bool,uint256),uint256))
func (_Mevcommitmiddleware *MevcommitmiddlewareSession) GetVaultRecord(vault common.Address) (IMevCommitMiddlewareVaultRecord, error) {
	return _Mevcommitmiddleware.Contract.GetVaultRecord(&_Mevcommitmiddleware.CallOpts, vault)
}

// GetVaultRecord is a free data retrieval call binding the contract method 0xde4ce5f2.
//
// Solidity: function getVaultRecord(address vault) view returns((bool,(bool,uint256),uint256))
func (_Mevcommitmiddleware *MevcommitmiddlewareCallerSession) GetVaultRecord(vault common.Address) (IMevCommitMiddlewareVaultRecord, error) {
	return _Mevcommitmiddleware.Contract.GetVaultRecord(&_Mevcommitmiddleware.CallOpts, vault)
}
