...
type IVanillaRegistryStakedValidator struct {
	...
	Balance           *big.Int
	UnstakeOccurrence OccurrenceLibBlockHeightOccurrence
}
...
func (_Validatorregistryv1 *Validatorregistryv1Caller) StakedValidators(opts *bind.CallOpts, arg0 []byte) (struct {
	...
	outstruct.UnstakeOccurrence = *abi.ConvertType(out[3], new(OccurrenceLibBlockHeightOccurrence)).(*OccurrenceLibBlockHeightOccurrence)
