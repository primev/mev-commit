...
// WithdrawAsOwner is a paid mutator transaction binding the contract method 0xe7cf2f4a.
//
// Solidity: function withdrawAsOwner(bytes[] blsPubKeys, address withdrawalAddress) returns()
func (_Validatorregistryv1 *Validatorregistryv1Transactor) WithdrawAsOwner(opts *bind.TransactOpts, blsPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.contract.Transact(opts, "withdrawAsOwner", blsPubKeys, withdrawalAddress)
}

// WithdrawAsOwner is a paid mutator transaction binding the contract method 0xe7cf2f4a.
//
// Solidity: function withdrawAsOwner(bytes[] blsPubKeys, address withdrawalAddress) returns()
func (_Validatorregistryv1 *Validatorregistryv1Session) WithdrawAsOwner(blsPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.Contract.WithdrawAsOwner(&_Validatorregistryv1.TransactOpts, blsPubKeys, withdrawalAddress)
}

// WithdrawAsOwner is a paid mutator transaction binding the contract method 0xe7cf2f4a.
//
// Solidity: function withdrawAsOwner(bytes[] blsPubKeys, address withdrawalAddress) returns()
func (_Validatorregistryv1 *Validatorregistryv1TransactorSession) WithdrawAsOwner(blsPubKeys [][]byte, withdrawalAddress common.Address) (*types.Transaction, error) {
	return _Validatorregistryv1.Contract.WithdrawAsOwner(&_Validatorregistryv1.TransactOpts, blsPubKeys, withdrawalAddress)
}
