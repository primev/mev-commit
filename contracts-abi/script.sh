...
extract_and_save_abi "$BASE_DIR/out/VanillaRegistryV2.sol/VanillaRegistryV2.json" "$ABI_DIR/VanillaRegistryV2.abi"
...
generate_go_code "$ABI_DIR/VanillaRegistryV2.abi" "VanillaRegistryV2" "vanillaregistryv2"
