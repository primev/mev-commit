...
contract ProviderRegistryTest is Test {
    ...
    function test_ShouldSlashProvider() public {
        ...
        providerRegistry.slash(1 ether, provider, payable(bidder), 1e18, bytes32(0));
    ...
    function test_ShouldSlashProviderWithoutFeeRecipient() public {
        ...
        vm.expectCall(bidder, 1000000000000000000 wei, new bytes(0));
        providerRegistry.slash(1 ether, provider, payable(bidder), providerRegistry.ONE_HUNDRED_PERCENT(), bytes32(0));
    ...
    function test_ShouldRetrieveFundsWhenSlashIsGreaterThanStake() public {
        ...
        providerRegistry.slash(3 ether, provider, payable(bidder), providerRegistry.ONE_HUNDRED_PERCENT(), bytes32(0));
    ...
    function test_PenaltyFeeBehavior() public {
        ...
        providerRegistry.setPreconfManager(address(this));
        providerRegistry.slash(1e18 wei, provider, payable(bidder), 50 * providerRegistry.PRECISION(), bytes32(0));
        assertEq(
        ...
        providerRegistry.slash(1e18 wei, newProvider, payable(bidder), 50 * providerRegistry.PRECISION(), bytes32(0));
    ...
    function test_WithdrawStakedAmountWithoutFeeRecipient() public {
        ...
        providerRegistry.slash(1e18 wei, newProvider, payable(bidder), percent, bytes32(0));
        vm.prank(newProvider);
