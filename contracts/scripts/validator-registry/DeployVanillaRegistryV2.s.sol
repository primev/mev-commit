...
contract BaseDeploy is Script {
    function deployVanillaRegistry(
        ...
        console.log("Deploying VanillaRegistryV2 on chain:", block.chainid);
        ...
        console.log("VanillaRegistryV2 UUPS proxy deployed to:", address(proxy));
        VanillaRegistryV2 vanillaRegistry = VanillaRegistryV2(payable(proxy));
        console.log("VanillaRegistryV2 owner:", vanillaRegistry.owner());
        return proxy;
    }
}
