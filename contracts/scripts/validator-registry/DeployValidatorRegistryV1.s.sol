...
contract DeployHolesky is BaseDeploy {
    ...
    uint256 constant SLASH_AMOUNT = 0.00003 ether; 
    address constant SLASH_ORACLE = 0x4535bd6fF24860b5fd2889857651a85fb3d3C6b1;
    address constant SLASH_RECEIVER = 0x4535bd6fF24860b5fd2889857651a85fb3d3C6b1;
...
contract DeployAnvil is BaseDeploy {
    uint256 constant MIN_STAKE = 3 ether;
    uint256 constant SLASH_AMOUNT = 1 ether;
    address constant SLASH_ORACLE = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8;
    address constant SLASH_RECEIVER = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC;
    uint256 constant UNSTAKE_PERIOD_BLOCKS = 100;
