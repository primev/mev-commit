...
import {BidderRegistryStorageV2} from "./BidderRegistryStorageV2.sol";
import {IBlockTracker} from "../interfaces/IBlockTracker.sol";
import {WindowFromBlockNumber} from "../utils/WindowFromBlockNumber.sol";
import {FeePayout} from "../utils/FeePayout.sol";

/// @title Bidder Registry V2
/// @notice This contract is for bidder registry and staking.
/// @custom:oz-upgrades-from BidderRegistry
contract BidderRegistryV2 is
    IBidderRegistryV2,
    BidderRegistryStorageV2,
