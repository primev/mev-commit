...
import {IProviderRegistryV2} from "../interfaces/IProviderRegistryV2.sol";
import {ProviderRegistryStorageV2} from "./ProviderRegistryStorageV2.sol";
import {FeePayout} from "../utils/FeePayout.sol";
import {Errors} from "../utils/Errors.sol";

/// @title Provider Registry V2
/// @notice This contract is for provider registry and staking.
/// @custom:oz-upgrades-from ProviderRegistry
contract ProviderRegistryV2 is
    IProviderRegistryV2,
    ProviderRegistryStorageV2,
