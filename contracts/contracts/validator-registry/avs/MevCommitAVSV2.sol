...
contract MevCommitAVSV2 is IMevCommitAVS, MevCommitAVSStorage,
    Ownable2StepUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    
    /// @dev Modifier to ensure the provided operator is registered with MevCommitAVSV2.
    modifier onlyRegisteredOperator(address operator) {
        require(operatorRegistrations[operator].exists, "operator not registered");
        _;
    }

    /// @dev Modifier to ensure the sender is not a registered operator with MevCommitAVSV2.
    modifier onlyNonRegisteredOperator() {
        require(!operatorRegistrations[msg.sender].exists, "sender is registered operator");
        _;
    }

    /// @dev Modifier to ensure all provided validators are registered with MevCommitAVSV2.
    ...
    /// @dev Modifier to ensure all provided validators are not registered with MevCommitAVSV2.
    ...
    /// @dev Modifier to ensure the sender is a registered LST restaker with MevCommitAVSV2.
    modifier onlyRegisteredLstRestaker() {
        require(lstRestakerRegistrations[msg.sender].exists, "LST restaker not registered");
        _;
    }

    /// @dev Modifier to ensure the sender is not a registered LST restaker with MevCommitAVSV2.
    modifier onlyNonRegisteredLstRestaker() {
        require(!lstRestakerRegistrations[msg.sender].exists, "LST restaker is registered");
        _;
    }

    /// @dev Modifier to ensure the sender is the MevCommitAVSV2 freeze oracle account.
    ...
    /// @dev Registers an operator with the MevCommitAVSV2.
    ...
    /// @dev Allows an operator to request deregistration from the MevCommitAVSV2.
    ...
    /// @dev Allows an operator to deregister from the MevCommitAVSV2.
    ...
    /// @dev Allows a validator to request deregistration from the MevCommitAVSV2.
    ...
    /// @dev Allows a validator to deregister from the MevCommitAVSV2.
    ...
    /// @dev Allows an LST restaker to request deregistration from the MevCommitAVSV2.
    ...
    /// @dev Allows an LST restaker to deregister from the MevCommitAVSV2.
